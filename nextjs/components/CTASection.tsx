...
export default function CTASection({ phoneNumber, title }: CTASectionProps) {
  return (
    <div className="relative before:content-[''] before:absolute before:w-full before:h-full md:before:h-1/2 before:left-0 before:top-0 before:bg-accent before:z-0 overflow-hidden">
      <div className="pt-12 relative space-y-12 bg-no-repeat bg-top nbswo-bg">
        ...
        <Image src="/img/nbswo.png" width={1070} height={856} alt="would you like to get acquainted with Nation Business Suite without obligation" className="w-full max-w-[80%] mx-auto object-cover" priority />
      </div>
    </div>
  );
}

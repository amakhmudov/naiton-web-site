      ...
      <section className="container py-12">
        <ul className="flex max-lg:flex-col max-lg:space-y-6 items-start justify-center">
          <li className="lg:px-12">
            <a href={`tel:${phone}`} className="flex lg:flex-col md:text-center items-center lg:space-y-3 max-lg:space-x-3">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 18" width="14" height="18" fill="none" className="w-9 h-9 text-accent shrink-0">
                <path
                  fill="currentColor"
          ...
          <li className="lg:px-12">
            <span className="flex lg:flex-col md:text-center items-center lg:space-y-3 max-lg:space-x-3">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 18" width="16" height="18" fill="none" className="w-9 h-9 text-accent shrink-0">
                <path
                  fill="currentColor"
